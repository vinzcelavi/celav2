...
function Toast({ uniqueId, config = {}, className, children }: ToastProps) {
      ...
      <AnimatePresence>
        {isShown && (
          <motion.div
            ...
            animate={{ opacity: 1, y: isMobile ? -4 : 38, scale: 1 }}
